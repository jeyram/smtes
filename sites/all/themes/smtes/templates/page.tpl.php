...
<head>
  ...
  <?php print $styles; ?>
  <?php print $scripts; ?>
 <?php /*?> <script type="text/javascript">var addthis_config = {"data_track_clickback":true};</script>
  <script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#id=jeyram"></script><?php */?>
</head>
