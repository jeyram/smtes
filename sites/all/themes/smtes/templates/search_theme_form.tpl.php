...
?>
 ...
 <table id="search" class="container-inline" cellspacing="0"><tbody style="border:0 none; vertical-align:top;"><tr>
	 <td class="searchBox" colspan="0"> 
		 <?php print $search['search_theme_form']; ?>
	  </td>
	  <td class="searchButton" colspan="0">
